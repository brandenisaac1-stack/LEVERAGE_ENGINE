...
function positionLeverageScenarioPanel(){
  const p=document.getElementById('leverageScenarioPanel');
  if(p)Object.assign(p.style,{position:'absolute',left:'18px',right:'auto',top:'48px',zIndex:'30'});
}
function render(){positionLeverageScenarioPanel();
